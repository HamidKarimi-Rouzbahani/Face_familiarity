...
for region=[1 2 3]
    for stim_resp=[1 2]
        for coherence=[1:4]
            ...
            if stim_resp==1
                save(['st_Decoding_fam_unfam_tr_cor_ts_cor_baselined_windowed_region_',num2str(region),'_Coh',num2str(coherences(coherence)),'V2.mat'],'accuracy');
            else
                save(['rp_Decoding_fam_unfam_tr_cor_ts_cor_baselined_windowed_region_',num2str(region),'_Coh',num2str(coherences(coherence)),'V2.mat'],'accuracy');
            end
        end
    end
end
