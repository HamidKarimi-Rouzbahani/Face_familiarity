...
for region=[3 2 1]
    for stim_resp=[1 2]
        for subj=[1:16 20 21]
            ...
            cc=0;
            for counte=[0.22 0.30 0.45 0.55]
                tmpt=[];
                cc=cc+1;
                if subj==13
                    sessions=1;
...
%                         tmp(6,iter)=sum(label(inds_tst6)==y2(inds_tst6))./sum(inds_tst6);
                ...
                if stim_resp==1
                    save(['st_Decoding_coh_low_high_tr_all_ts_all_baselined_windowed_region_',num2str(region),'.mat'],'accuracy');
                else
                    save(['rp_Decoding_coh_low_high_tr_all_ts_all_baselined_windowed_region_',num2str(region),'.mat'],'accuracy');
                end
            end
        end
    end
