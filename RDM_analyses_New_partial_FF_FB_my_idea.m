...
%                     ParCorrelations_FB(subj,time)=partialcorr(reshape(Neural_RDM_ocpt_present,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1]),reshape(Neural_RDM_frnt_past,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]),[reshape(Neural_RDM_ocpt_past,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1]) reshape(Image_RDM,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1])],'rows','complete');
                    ParCorrelations_FF_Fam_Unfam(subj,time)=partialcorr(reshape(Familiar_Unfamiliar_Model_RDM,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]),reshape(Neural_RDM_frnt_present,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]),[reshape(Neural_RDM_ocpt_past,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1]) reshape(Image_RDM,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1])],'rows','complete');
                    ParCorrelations_FB_Fam_Unfam(subj,time)=partialcorr(reshape(Familiar_Unfamiliar_Model_RDM,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1]),reshape(Neural_RDM_ocpt_present,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1]),[reshape(Neural_RDM_frnt_past,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]) reshape(Image_RDM,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1])],'rows','complete');                    
                    ParCorrelations_FF_Fam_Unfam_Self_Out(subj,time)=partialcorr(reshape(Familiar_Unfamiliar_Model_RDM,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]),reshape(Neural_RDM_frnt_present,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]),[reshape(Neural_RDM_frnt_past,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]) reshape(Neural_RDM_ocpt_past,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1]) reshape(Image_RDM,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1])],'rows','complete');
                    ParCorrelations_FB_Fam_Unfam_Self_Out(subj,time)=partialcorr(reshape(Familiar_Unfamiliar_Model_RDM,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1]),reshape(Neural_RDM_ocpt_present,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1]),[reshape(Neural_RDM_frnt_past,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]) reshape(Neural_RDM_ocpt_past,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]) reshape(Image_RDM,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1])],'rows','complete');
                    
                    
                    ParCorrelations_FF_Fam_Levels(subj,time)=partialcorr(reshape(Familiarity_levels_Model_RDM,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]),reshape(Neural_RDM_frnt_present,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]),[reshape(Neural_RDM_ocpt_past,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1]) reshape(Image_RDM,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1])],'rows','complete');
                    ParCorrelations_FB_Fam_Levels(subj,time)=partialcorr(reshape(Familiarity_levels_Model_RDM,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1]),reshape(Neural_RDM_ocpt_present,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1]),[reshape(Neural_RDM_frnt_past,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]) reshape(Image_RDM,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1])],'rows','complete');
                    ParCorrelations_FF_Fam_Levels_Self_Out(subj,time)=partialcorr(reshape(Familiarity_levels_Model_RDM,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]),reshape(Neural_RDM_frnt_present,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]),[reshape(Neural_RDM_frnt_past,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]) reshape(Neural_RDM_ocpt_past,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1]) reshape(Image_RDM,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1])],'rows','complete');
                    ParCorrelations_FB_Fam_Levels_Self_Out(subj,time)=partialcorr(reshape(Familiarity_levels_Model_RDM,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1]),reshape(Neural_RDM_ocpt_present,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1]),[reshape(Neural_RDM_frnt_past,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]) reshape(Neural_RDM_ocpt_past,[size(signals_frnt{1,1},3)*size(signals_frnt{1,1},3) 1]) reshape(Image_RDM,[size(signals_ocpt{1,1},3)*size(signals_ocpt{1,1},3) 1])],'rows','complete');
