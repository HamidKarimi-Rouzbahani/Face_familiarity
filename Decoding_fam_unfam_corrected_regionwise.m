    ...
    for stim_resp=[1 2]
        for subj=[1:16 20 21]
            ...
            if test_on_errors==1
                ...
                if stim_resp==1
                    save(['st_Decoding_fam_unfam_tr_cor_ts_incor_baselined_windowed_region_',num2str(region),'_v4.mat'],'accuracy');
                else
                    save(['rp_Decoding_fam_unfam_tr_cor_ts_incor_baselined_windowed_region_',num2str(region),'_v4.mat'],'accuracy');
                end
            else
                %% SVM
                cond1=1;
                ...
                if stim_resp==1
                    save(['st_Decoding_fam_unfam_tr_cor_ts_cor_baselined_windowed_region_',num2str(region),'_.mat'],'accuracy');
                else
                    save(['rp_Decoding_fam_unfam_tr_cor_ts_cor_baselined_windowed_region_',num2str(region),'_.mat'],'accuracy');
                end
            end
        end
    end
