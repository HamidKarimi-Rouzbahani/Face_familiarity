    ...
    for stim_resp=[2]
        for coherence=1:length(Coherences)
            for subj=[1:16]
                ...
                if stim_resp==1
                    save(['st_aligned_partialRDM_IMG_SP_New_randoming_pls_NoPart_correlations_baselined_windowed_region_',num2str(region),'_coherence_',num2str(Coherences(coherence)),'.mat'],'ParCorrelations_Fam_Unfam','ParCorrelations_Fam_Levels','ParCorrelations_Fam_Unfam_random','ParCorrelations_Fam_Levels_random','ParCorrelations_Fam_Unfam_NP','ParCorrelations_Fam_Levels_NP','ParCorrelations_Fam_Unfam_random_NP','ParCorrelations_Fam_Levels_random_NP');
                else
