...
%                         toc
            ...
            %             end
            if stim_resp==1
                save(['st_Decoding_fam_unfam_tr_cor_ts_cor_baselined_windowed_region_',num2str(region),'_channels.mat'],'accuracy');
            else
                save(['rp_Decoding_fam_unfam_tr_cor_ts_cor_baselined_windowed_region_',num2str(region),'_channels.mat'],'accuracy');
            end
            %         end
    end
end
