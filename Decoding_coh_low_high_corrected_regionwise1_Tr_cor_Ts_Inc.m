...
%                         
                ...
                if stim_resp==1
                    save(['st_Decoding_coh_low_higher_tr_cor_ts_inc_baselined_windowed_region_',num2str(region),'.mat'],'accuracy');
                else
                    save(['rp_Decoding_coh_low_higher_tr_cor_ts_inc_baselined_windowed_region_',num2str(region),'.mat'],'accuracy');
                end
            else
                %% SVM
                cond1=1;
