...
for subj=[1:16 20 21]
    for cats=[0 1]
        for stim_resp=[1 2]
            ...
            clearvars -except famous_effect subject sessions steps baseline_correction baseline_span signals subj cats stim_resp only_answered_trials only_correct_trials
            %% IRLS
            landa=0.1;
            b=0.1;
            span=50;
            ...
            if stim_resp==1
                if cats==0
                    save(['st_al_weights_coh_level_1_4_subj_',num2str(subj),'conc_ALLtrials.mat'],'wp','span','landa','b');
                else
                    save(['st_al_weights_cat_level_1_4_subj_',num2str(subj),'conc_ALLtrials.mat'],'wp','span','landa','b');
                end
            else
                if cats==0
                    save(['rp_al_weights_coh_level_1_4_subj_',num2str(subj),'conc_ALLtrials.mat'],'wp','span','landa','b');
                else
                    save(['rp_al_weights_cat_level_1_4_subj_',num2str(subj),'conc_ALLtrials.mat'],'wp','span','landa','b');
                end
            end
            clearvars wp wt wtb
        end
