        ...
        for subj=[1:16 20 21]
            coherence=4;
                ...
                if test_on_errors==1
                    ...
                    if stim_resp==1
                        save(['st_Decoding_fam_unfam_tr_0.55_ts_0.22_region_',num2str(region),'.mat'],'accuracy');
                    else
                        save(['rp_Decoding_fam_unfam_tr_0.55_ts_0.22_region_',num2str(region),'.mat'],'accuracy');
                    end
                else
                    %% SVM
                    cond1=1;
                    ...
                    for tws=1:steps:2000-steps
                        ...
                        [test_on_errors region stim_resp subj coherence time]
                        accuracy(subj,:,time)=squeeze(nanmean(tmp,2));
                    end
                    if stim_resp==1
                        save(['st_Decoding_fam_unfam_tr_all_ts_all_baselined_windowed_region_',num2str(region),'_Coh',num2str(coherences(coherence)),'.mat'],'accuracy');
                    else
                        save(['rp_Decoding_fam_unfam_tr_all_ts_all_baselined_windowed_region_',num2str(region),'_Coh',num2str(coherences(coherence)),'.mat'],'accuracy');
                    end
                end
        end
    end
