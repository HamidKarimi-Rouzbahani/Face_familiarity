...
only_incorrect_trials=1; % plus correct=0
...
for subj=[1:16 20 21]
    for cats=[0 1]
        for stim_resp=[1 2]
            ...
            if stim_resp==1
                if cats==0
                    save(['st_al_weights_coh_level_1_4_subj_',num2str(subj),'conc_incor.mat'],'wp','span','landa','b');
                else
                    save(['st_al_weights_cat_level_1_4_subj_',num2str(subj),'conc_incor.mat'],'wp','span','landa','b');
                end
            else
                if cats==0
                    save(['rp_al_weights_coh_level_1_4_subj_',num2str(subj),'conc_incor.mat'],'wp','span','landa','b');
                else
                    save(['rp_al_weights_cat_level_1_4_subj_',num2str(subj),'conc_incor.mat'],'wp','span','landa','b');
                end
            end
            clearvars wp wt wtb
        end
