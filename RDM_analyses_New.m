...
Correlations_Fam_Unfam_random=nan*ones(21,71,100);
Correlations_Fam_Levels_random=nan*ones(21,71,100);
test_on_errors=0;
    ...
    for stim_resp=[1 2]
        for coherence=1:length(Coherences)
            for subj=[1:16 20 21]
                ...
                if stim_resp==1
                    save(['st_aligned_RDM_New_randoming_correlations_baselined_windowed_region_',num2str(region),'_coherence_',num2str(Coherences(coherence)),'.mat'],'Correlations_Fam_Unfam','Correlations_Fam_Levels','Correlations_Fam_Unfam_random','Correlations_Fam_Levels_random');
                else
                    save(['rp_aligned_RDM_New_randoming_correlations_baselined_windowed_region_',num2str(region),'_coherence_',num2str(Coherences(coherence)),'.mat'],'Correlations_Fam_Unfam','Correlations_Fam_Levels','Correlations_Fam_Unfam_random','Correlations_Fam_Levels_random');
                end
            end
        end
    end
